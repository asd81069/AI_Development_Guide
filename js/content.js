...
`
...

  {
    ...
    html: `
      ...
      <div class="figure">
        <img alt="操作示意截圖" src="https://www.genspark.ai/api/files/s/tKdZ85wp" />
...
- 提供我：1) 你改了哪些檔案 2) 我需要新增哪些 env vars 3) 我怎麼在本機跑起來測試</code></pre>
      ...
      <div class="figure">
        <img alt="操作示意截圖" src="https://www.genspark.ai/api/files/s/rd4FtLKf" />
...
`
...

  {
    ...
    html: `
      ...
      <div class="figure">
        <img alt="操作示意截圖" src="https://www.genspark.ai/api/files/s/ekmjdVzI" />
...
3) 任何輸出都要放到 /handbook-workspace/outputs/ 並附上日期。</code></pre>
      ...
      <div class="figure">
        <img alt="Genspark 任務畫面截圖" src="https://www.genspark.ai/api/files/s/g9fPHEZb" />
...
`
...

  {
    ...
    html: `
      ...
      <div class="figure">
        <img alt="操作示意截圖" src="https://www.genspark.ai/api/files/s/vWKA9eg1" />
